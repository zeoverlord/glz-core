...
namespace GLZ
{
	...
	void glzSprite::make_polygons(std::vector<poly3> *pdata, float x, float y, float width, float height, int group, int atlas)
	{
	...
	void glzSprite::make_polygons(std::vector<poly3> *pdata, float x, float y, float width, float height, int group, int atlas, glzMatrix m)
	{
	...
	void glzSprite::make_polygons(std::vector<poly3> *pdata, float x, float y, float width, float height, int group, int atlas, glzOrigin origin, glzMatrix m)
	{

		poly3 p1, p2;
		std::vector<poly3> pdata_temp;
