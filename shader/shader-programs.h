...
namespace GLZ
{
	...
	std::string const passtrough_vertex = {
	...
	std::string const passtrough_fragment = {
		"#version 140\r\n"
		""
		"in vec4 tc;"
	...
	std::string const basic_fragment = {
		"#version 140\r\n"
		""
		"in vec4 tc;"
		"uniform  vec4 color;"
	...
	std::string const colortint_vertex = {
	...
	std::string const colortint_fragment = {
		"#version 140\r\n"
		""
		"uniform  vec4 color;"
		"out vec4 fragment_color;"
	...
	std::string const tilemap_vertex = {
		"#version 140\r\n"
		""
		"in vec3 Position;"
		"in vec2 TexCoord;"
	...
	std::string const tilemap_fragment = {
		"#version 140\r\n"
		""
		"in vec4 txcoord;\r\n"
		"uniform  vec4 color;\r\n"
		...
		std::string const tiledSprite_vertex = {
		...
		std::string const tiledSprite_fragment = {
		"#version 140\r\n"
		""
		"in vec4 tc;"
		"uniform  vec4 color;\r\n"
