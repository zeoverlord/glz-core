...
namespace GLZ
{
	...
	static std::vector<GLint> tempprogram;
	...
	void loadShaderString(unsigned int program, std::string const shadercode, glzShadertype type)  //loads a vertex shader in glsl format
	{
	...
	void loadShaderFile(unsigned int program, std::string const filename, glzShadertype type)  //loads a vertex shader in glsl format
	{
